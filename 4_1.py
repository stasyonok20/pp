...
START_limit = int(math.pow(math.pow(10,4),0.25))
END_limit = int(math.pow(math.pow(10,5),0.25))
...
#Находим потенциальные числа с 3 делителями
for i in range (0, len(allPrime)):
    allPrime[i] = math.pow(allPrime[i],4)
print (allPrime)
